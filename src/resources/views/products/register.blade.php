                ...
                <div class="register__radio">
                    @foreach($seasons as $season)
                        <label class="radio__label custom-checkbox">
                            <input name="seasons[]" type="checkbox" class="radio__input" value="{{ $season->id }}" {{ is_array(old('seasons')) && in_array($season->id, old('seasons'), true) ? ' checked' : '' }} aria-labelledby="seasonLabel">
                            {{ $season->name }}
